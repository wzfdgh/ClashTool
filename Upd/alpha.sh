...
gh=https://github.com/wzfdgh/ClashRepo/releases/download/latest/clash.meta-$os-$arch
gp=https://mirror.ghproxy.com/github.com/wzfdgh/ClashRepo/releases/download/latest/clash.meta-$os-$arch
